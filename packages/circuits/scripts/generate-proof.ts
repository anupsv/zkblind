...
import { generateBlindVerifierCircuitInputs } from "../helpers";
...
program
    ...
    .requiredOption(
        ...
        "Ethereum address to verify blind handle against"
    )
...
async function generate() {
    ...
    const circuitInputs = await generateBlindVerifierCircuitInputs({
        ...
        semCommitment: "11237622825477336339577122413451117718539783476837539122310492284566644730311"
    });
    ...
    fs.writeFileSync(path.join(OUTPUT_DIR, `${CIRCUIT_NAME}.wtns`), buff);
