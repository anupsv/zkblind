...
import {
  generateBlindVerifierCircuitInputs,
  IBlindCircuitInputs,
} from "@zkblind/circuits/helpers";
...
const CIRCUIT_NAME = "blind";

export const MainPage: React.FC<{}> = (props) => {
  const { address } = useAccount();

  const [ethereumAddress, setEthereumAddress] = useState<string>(address ?? "");
  const [semaphoreCommitment, setSemaphoreCommitment] = useState<string>("");
    ...
    <Container>
      ...
      <Main>
        <Column>
          ...
          />
          <SingleLineInput
              label="Semaphore Commitment"
              value={semaphoreCommitment}
              onChange={(e) => {
                setSemaphoreCommitment(e.currentTarget.value);
              }}
          />
          <Button
            ...
            onClick={async () => {
              ...
              let input: IBlindCircuitInputs;
              try {
                setDisplayMessage("Generating proof...");
                setStatus("generating-input");

                input = await generateBlindVerifierCircuitInputs({
                  ...
                  ethereumAddress,
                  semCommitment: semaphoreCommitment
                });
        ...
        <Column>
          ...
          >
            {isSuccess
              ...
              ? "Confirm in wallet"
              : verificationPassed
              ? "Submit commitment on-chain and Join Company"
